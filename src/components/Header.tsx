        ...
        <div className='flex items-center space-x-2'>
          {!user ? (
            <>
              ...
              <Link
                to='/register'
                className='bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium rounded-md transition px-4 py-2 leading-none'
              >
                Register
              </Link>
            </>
            ...
            <>
              <span className='hidden text-gray-700 font-medium px-2 sm:block'>
                Welcome, {user.name}
              </span>
              <button
                onClick={handleLogout}
                className='text-red-600 font-md transition px-3 py-2 leading-none cursor-pointer hover:text-red-900'
              >
                Logout
              </button>
            </>
